...
--
-- Host: localhost
-- Gegenereerd op: 27 nov 2024 om 10:41
...
INSERT INTO `reviews` (`id`, `user_id`, `user_firstname`, `product_id`, `text`, `rating`) VALUES
(1, 7, 'Anna', 1, 'Heel goede case! Heel blij mee 😁', '⭐️⭐️⭐️⭐️⭐️'),
(19, 3, 'Bob', 6, 'Deze laptop tas is stevig, stijlvol en biedt voldoende ruimte voor je laptop en accessoires. Het gewatteerde vak biedt goede bescherming tegen stoten. De tas is licht genoeg om gemakkelijk te dragen, maar kan wat zwaar aanvoelen als hij vol is. Al met al een betrouwbare tas voor dagelijks gebruik!', '⭐⭐⭐⭐☆'),
(60, 7, 'Anne', 16, 'Stevig, stijlvol en beschermend. Past perfect en voorkomt krassen en stoten. Een must-have!', '⭐️⭐️⭐️⭐️⭐️');
...
(3, 'fien@shop.com', '$2y$12$HEJlvFRWl/Gss8DF3MPYTuuVQOXIe8ZI1Oy4D74eNAj7thw8aiaeC', 'Fien', 'Wouters', 1),
(4, 'test@test.com', '$2y$12$r/pCDw69OhexRY/PE9ZHXuCTJEAPSKAlN6dvyfbG6WujwyG9R9vxi', 'test', 'tester', 0),
(7, 'Annedesmet@outlook.com', '$2y$12$lqAw.s4HeCp0yvIiQl5FTO3i.39UXj7hTgNdN4LK7NEv3J2aE.lsm', 'Anne', 'De Smet', 0),
(9, 'admin@admin.com', '$2y$12$1JGwJUQdI5O19XJzNWumQuRaSr6kmpb8QkivppGSsnHVCH2D/XBg.', 'Admin', 'Admin', 1),
(10, 'user@user.com', '$2y$12$ODVhFPWwVQWmW.tm6vzSy.9j4R3lSoiTVpOl2ytFtpaAppE41qe7W', 'User', 'User', 0),
(11, 'Jos@outlook.com', '$2y$12$eAfYM.ryxgZc0NwB37GWbOI.Twi6Ag4Q70wDx9SCQOlkvlk3h3zXS', 'Jos', 'De Boer', 0);
